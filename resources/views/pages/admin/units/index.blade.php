...
@section('content')
    <x-common.page-breadcrumb pageTitle="Unit" />
    ...
    <x-common.component-card title="Daftar Unit">
        <div class="flex justify-end">
            <a href="{{ route('units.create') }}">
                <x-ui.button size="sm">Tambah Unit</x-ui.button>
            </a>
        </div>
            ...
            <div class="max-w-full overflow-x-auto custom-scrollbar">
                <table class="w-full min-w-[500px]">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($units as $unit)
                            <tr>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-700 text-theme-sm dark:text-gray-300">{{ $unit->name }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $unit->tickets_count }}</p>
                                </td>
                                <td class="px-5 py-4 sm:px-6">
                                    <div class="flex justify-end relative">
                                        <x-common.table-dropdown>
                                            ...
                                            <x-slot name="content">
                                                <a href="{{ route('units.edit', $unit) }}" class="flex w-full px-3 py-2 font-medium text-left text-gray-500 rounded-lg text-theme-xs hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">Ubah</a>
                        ...
                        @empty
                            <tr><td colspan="3" class="px-5 py-6 text-center text-gray-400">Belum ada unit.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
