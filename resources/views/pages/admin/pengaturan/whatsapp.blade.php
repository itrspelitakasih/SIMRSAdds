                ...
                <form method="POST" action="{{ route('pengaturan.whatsapp.update') }}" class="space-y-4">
                    ...
                    <div class="space-y-5 border-t border-gray-100 pt-5 dark:border-gray-800">
                        ...
                        <div>
                            ...
                            <textarea name="msg_ticket_created_admin" rows="8"
                                class="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:outline-hidden dark:border-gray-700 dark:text-white/90">{{ old('msg_ticket_created_admin', $setting->msg_ticket_created_admin ?: $defaultTemplates['msg_ticket_created_admin']) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="msg_ticket_created_reporter" rows="5"
                                class="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:outline-hidden dark:border-gray-700 dark:text-white/90">{{ old('msg_ticket_created_reporter', $setting->msg_ticket_created_reporter ?: $defaultTemplates['msg_ticket_created_reporter']) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="msg_ticket_completed" rows="5"
                                class="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:outline-hidden dark:border-gray-700 dark:text-white/90">{{ old('msg_ticket_completed', $setting->msg_ticket_completed ?: $defaultTemplates['msg_ticket_completed']) }}</textarea>
                            <p class="mt-1 text-xs text-gray-400">Placeholder: <code>{kode_tiket}</code></p>
                        </div>

                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Pengingat Dokumen</label>
                            <textarea name="msg_document_reminder" rows="9"
                                class="dark:bg-dark-900 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:outline-hidden dark:border-gray-700 dark:text-white/90">{{ old('msg_document_reminder', $setting->msg_document_reminder ?: $defaultTemplates['msg_document_reminder']) }}</textarea>
