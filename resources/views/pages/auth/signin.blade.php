                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Login untuk Admin IT E-Tiket Rumah Sakit
                            </p>
                        </div>
                        <div>
                            @if (session('status'))
                                <div class="mb-4 rounded-lg bg-success-50 px-4 py-3 text-sm text-success-600 dark:bg-success-500/15">
                                    {{ session('status') }}
                                </div>
                            @endif
                            <form method="POST" action="{{ route('signin.attempt') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="admin@rs.local"
